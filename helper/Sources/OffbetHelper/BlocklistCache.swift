...
enum BlocklistCache {
    struct Lists: Codable { var domains: [String]; var tokens: [String]; var allowlist: [String] }

    static let defaultPath = "/Library/Application Support/OFFBET/blocklist.json"

    static func save(domains: [String], tokens: [String], allowlist: [String], to path: String = defaultPath) {
    ...
    static func load(from path: String = defaultPath) -> Lists? {
